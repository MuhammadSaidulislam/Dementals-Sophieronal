    ...
    return (
        <section className='meantals'>
            <Container fluid  >
                        ...
                        <OwlCarousel className="owl-theme text-center mentalCarousel" {...options}>
                            <div className='item'>
                            ...
                            <div className='item'>
                                ...
                                <div className='text-center mt-2'>
                                    ...
                                    <p className='userDesc'>Managing Editor of Coindesk Founder of Pixelmind & Tokenly Host for Speaking of Bitcoin Podcast</p>
                                </div>
                            </div>
                            <div className='item'>
                                ...
                                <div className='text-center mt-2'>
                                    ...
                                    <p className='userDesc'>Experienced UI / UX Designer Licensed Console Game Developer Studio Director at Feralblast</p>
                                </div>
                            </div>
                            <div className='item'>
                                <img alt='user-logo' src={'./user-logo/92614c47-7239-4a50-a207-8f20a2f93e52.png'} />
                                <div className='text-center mt-2'>
                                    <h4 className='userName'>SPPR</h4>
                                    <p className='userPos'>Blockchain Engineer</p>
                                    <p className='userDesc'>Experienced Smart Contract Dev Full Stack Web Dev</p>
                                </div>
                            </div>
                            <div className='item'>
                                ...
                                <div className='text-center mt-2'>
                                    ...
                                    <p className='userDesc'>Composers of the Official Soundtrack for the Dementals</p>
                                </div>
                            </div>
                        </OwlCarousel>
            </Container>
